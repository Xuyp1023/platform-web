...
public class CustRelationConfigController {
    ...
    public @ResponseBody String queryCustRelationByCore(Long custNo, String relationType, String flag, int pageNum,
            int pageSize) {
        logger.info("添加客户关系，入参：custNo=" + custNo);
        return exec(() -> custRelationConfigService.webQueryCustRelation(custNo, flag, pageNum, pageSize, relationType),
                "分页查询客户关系信息", logger);
    }
    ...
    public @ResponseBody String addFactorCustRelation(String factorCustType, String wosCustType,
            String factorCustNoList, String wosCustNoList, Long custNo) {
