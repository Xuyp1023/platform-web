...
public class BankAccountController {
    ...
    public @ResponseBody String addInsteadBankAccountTmp(HttpServletRequest request, Long insteadRecordId,
            String fileList) {
        final Map<String, Object> reqParam = Servlets.getParametersStartingWith(request, "");
    ...
    public @ResponseBody String saveInsteadBankAccountTmp(HttpServletRequest request, Long insteadRecordId,
            String fileList) {
        final Map<String, Object> reqParam = Servlets.getParametersStartingWith(request, "");
    ...
    public @ResponseBody String deleteInsteadBankAccountTmp(HttpServletRequest request, Long refId,
