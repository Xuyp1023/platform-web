...
public class CustOpenAccountController {
    ...
    public @ResponseBody String findOpenAccountInfoById(final Long id) {
        logger.info("客户开户资料读取");
        try {
    ...
    public @ResponseBody String queryOpenAccountApply(final String flag, final int pageNum, final int pageSize) {
        try {
    ...
    public @ResponseBody String saveAuditOpenAccountApply(final Long id, final String auditOpinion) {
    ...
    public @ResponseBody String saveRefuseOpenAccountApply(final Long id, final String auditOpinion) {
    ...
    public @ResponseBody String findOpenAccountInfoByInsteadId(final Long id) {
    ...
    public @ResponseBody String queryOpenAccWorkflow(final Long custNo) {
    ...
    public @ResponseBody String queryOpenAccWorkflowById(final Long openAccId) {
    ...
    public @ResponseBody String checkCustExistsByCustName(final String custName) {
    ...
    public @ResponseBody String checkCustExistsByBankAccount(final String bankAccount) {
    ...
    public @ResponseBody String checkCustExistsByEmail(final String email) {
    ...
    public @ResponseBody String checkCustExistsByMobileNo(final String mobileNo) {
