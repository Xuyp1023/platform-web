...
public class ContractStandardTypeController {
    ...
    public @ResponseBody String queryContractStandardType(int pageNum, int pageSize, String flag) {
        ...
        return ControllerExceptionHandler.exec(
                () -> contractStandardTypeService.webQueryContractStandardType(pageNum, pageSize, flag), "合同类型登记查询失败",
                logger);
    }
    ...
    public @ResponseBody String queryUnEnableAgreementType(int pageNum, int pageSize, String flag) {
        ...
        return exec(() -> contractStandardTypeService.webQueryUnEnableContractStandardType(pageNum, pageSize, flag),
                "查询未启用标准合同类型失败", logger);
    }
    ...
    public @ResponseBody String queryAllAgreementType(final HttpServletRequest request, int pageNum, int pageSize,
            String flag) {
        ...
        return exec(() -> contractStandardTypeService.webQueryAllContractStandardType(anMap, pageNum, pageSize, flag),
                "查询所有的标准合同类型出错", logger);
    }
