...
public class ContractCorpAccountController {
    ...
    public @ResponseBody String saveCorpSigner(final HttpServletRequest request, final Long corpAccountId, final Long signerAccountId) {
        return exec(() -> contractCorpAccountService.webSaveCorpSigner(corpAccountId, signerAccountId), "设置企业签署人出错！", logger);
    }
