...
public class ContractSignerAccountController {
    ...
    public @ResponseBody String querySignerAccountInfo(final HttpServletRequest request, final Long anCustNo,
            final int flag, final int pageNum, final int pageSize) {
        return exec(() -> contractSignerAccountService.webQuerySignerAccountInfo(anCustNo, flag, pageNum, pageSize),
                "获取操作员信息出错！", logger);
    }
